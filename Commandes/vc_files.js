...
zokou({ nomCom: 'channel',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`Support Here My Owner By Join This Group Please 
...
zokou({ nomCom: 'group1',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*Tap Here To Join KIBORE MD Chatroom* https://chat.whatsapp.com/DFmm1OBboewBk9kEDBrfNv`) 
...
zokou({ nomCom: 'update',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_KIBORE MD🎁is running on its latest vision_*`) 
...
zokou({ nomCom: 'vision',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_𝐛𝐨𝐭 𝐜𝐫𝐞𝐚𝐭𝐞𝐝 𝐛𝐲 𝙺𝙸𝙱𝙾𝚁𝙴 𝙲𝙼𝙳🥴𝐯𝐢𝐬𝐢𝐨𝐧 𝐢𝐬 97162963^𝐬𝐯_*`) 
